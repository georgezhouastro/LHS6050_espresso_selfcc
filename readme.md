...
https://drive.google.com/drive/folders/1vLA7pI8-YgivtWEHE8WNF9FGAq8X8syc?usp=sharing
...
LHS6050.rv.csv: The final aggregated catalog containing Barycentric Julian Dates (bjd), self-cc RVs from this pipeline (selfrv), DRS RVs (maskrv), and their respective errors/asymmetry metrics.
